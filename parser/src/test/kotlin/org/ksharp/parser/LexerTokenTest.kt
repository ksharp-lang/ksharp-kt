...
class LexerTokenTest : StringSpec({
    ...
    "Check LexerToken collapse" {
        ...
        val collapsed = token1.collapse(KSharpTokenType.Then, "J", token2) as LexerToken
        collapsed.type.shouldBe(KSharpTokenType.Then)
    ...
    "Check LogicalLexerToken collapse" {
        ...
        val collapsed = logicalToken1.collapse(KSharpTokenType.Then, "J", logicalToken2) as LogicalLexerToken
        collapsed.type.shouldBe(KSharpTokenType.Then)
        collapsed.text.shouldBe("J")
        collapsed.startOffset.shouldBe(2)
        collapsed.endOffset.shouldBe(10)
